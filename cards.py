...
if yes_pygame:
    ...
    class Prototype(pygame.sprite.Sprite):
        ...
        def play_cast_sound(self):
            pygame.mixer.music.load(
                current_folder + '/misc/sounds/card_cast.ogg'
            )
            wzglobals.playmusic()
            return
        ...
        def die(self):
            ...
            try:
                pygame.mixer.music.load(
                    current_folder + '/misc/sounds/card_die.ogg'
                )
            except:
    ...
    class Nixie(Prototype):
        ...
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/nixie.gif'
            )
            self.info = _(
    ...
    class Hydra(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/hydra.gif'
            )
    ...
    class Waterfall(Prototype):
        def __init__(self):
            ...
            self.health = 33
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/waterfall.gif'
            )
            self.info = _(
    ...
    class Leviathan(Prototype):
        def __init__(self):
            ...
            self.health = 37
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/leviathan.gif'
            )
            self.info = _(
    ...
    class IceGuard(Prototype):
        def __init__(self):
            ...
            self.health = 19
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/ice_guard.gif'
            )
            Prototype.__init__(self)
    ...
    class Poseidon(Prototype):
        def __init__(self):
            ...
            self.health = 25
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/poseidon.gif'
            )
            Prototype.__init__(self)
    ...
    class IceWizard(Prototype):
        def __init__(self):
            ...
            self.health = 22
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/ice_wizard.gif'
            )
            Prototype.__init__(self)
    ...
    class Demon(Prototype):
        def __init__(self):
            ...
            self.health = 12
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/demon.gif'
            )
            Prototype.__init__(self)
    ...
    class Devil(Prototype):
        def __init__(self):
            ...
            self.health = 27
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/devil.gif'
            )
            Prototype.__init__(self)
    ...
    class RedDrake(Prototype):
        def __init__(self):
            ...
            self.health = 16
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/red_drake.gif'
            )
            Prototype.__init__(self)
    ...
    class Firelord(Prototype):
        def __init__(self):
            ...
            self.health = 21
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/firelord.gif'
            )
            Prototype.__init__(self)
    ...
    class Salamander(Prototype):
        def __init__(self):
            ...
            self.health = 15
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/salamander.gif'
            )
            Prototype.__init__(self)
    ...
    class Efreet(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/efreet.gif'
            )
            Prototype.__init__(self)
    ...
    class Vulcan(Prototype):
        def __init__(self):
            ...
            self.health = 27
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/vulcan.gif'
            )
            Prototype.__init__(self)
    ...
    class Cerberus(Prototype):
        def __init__(self):
            ...
            self.health = 6
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/cerberus.gif'
            )
            Prototype.__init__(self)
    ...
    class Nymph(Prototype):
        def __init__(self):
            ...
            self.health = 12
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/nymph.gif'
            )
            Prototype.__init__(self)
    ...
    class Fairy(Prototype):
        def __init__(self):
            ...
            self.health = 7
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/fairy.gif'
            )
            Prototype.__init__(self)
    ...
    class Phoenix(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder+'/misc/cards/air/phoenix.gif'
            )
            Prototype.__init__(self)
    ...
    class Zeus(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/zeus.gif'
            )
            Prototype.__init__(self)
    ...
    class Gargoyle(Prototype):
        def __init__(self):
            ...
            self.health = 15
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/gargoyle.gif'
            )
            self.stone = False
            Prototype.__init__(self)
    ...
    class Manticore(Prototype):
        def __init__(self):
            ...
            self.health = 19
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/manticore.gif'
            )
            Prototype.__init__(self)
    ...
    class Titan(Prototype):
        def __init__(self):
            ...
            self.health = 28
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/titan.gif'
            )
            Prototype.__init__(self)
    ...
    class Satyr(Prototype):
        def __init__(self):
            ...
            self.health = 10
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/satyr.gif'
            )
            Prototype.__init__(self)
    ...
    class Golem(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/golem.gif'
            )
            Prototype.__init__(self)
    ...
    class Dryad(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/dryad.gif'
            )
            Prototype.__init__(self)
    ...
    class ForestSpirit(Prototype):
        def __init__(self):
            ...
            self.health = 3
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/forest_spirit.gif'
            )
            Prototype.__init__(self)
    ...
    class Centaur(Prototype):
        def __init__(self):
            ...
            self.health = 14
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/centaur.gif'
            )
            Prototype.__init__(self)
            self.moves_alive = 1
    ...
    class Elemental(Prototype):
        def __init__(self):
            ...
            self.health = 45
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/elemental.gif'
            )
            Prototype.__init__(self)
    ...
    class Ent(Prototype):
        def __init__(self):
            ...
            self.health = 22
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/ent.gif'
            )
            Prototype.__init__(self)
    ...
    class Echidna(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/echidna.gif'
            )
            Prototype.__init__(self)
    ...
    class Priest(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/priest.gif'
            )
            Prototype.__init__(self)
    ...
    class Paladin(Prototype):
        def __init__(self):
            ...
            self.health = 20
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/paladin.gif'
            )
            Prototype.__init__(self)
    ...
    class Pegasus(Prototype):
        def __init__(self):
            ...
            self.focus_cast = True
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/pegasus.gif'
            )
            Prototype.__init__(self)
    ...
    class Unicorn(Prototype):
        def __init__(self):
            ...
            self.health = 25
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/unicorn.gif'
            )
            Prototype.__init__(self)
    ...
    class Apostate(Prototype):
        def __init__(self):
            ...
            self.health = 14
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/apostate.gif'
            )
            Prototype.__init__(self)
    ...
    class MagicHealer(Prototype):
        def __init__(self):
            ...
            self.security_slots = []
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/magic_healer.gif'
            )
            Prototype.__init__(self)
    ...
    class Chimera(Prototype):
        def __init__(self):
            ...
            self.health = 30
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/chimera.gif'
            )
            Prototype.__init__(self)
    ...
    class Zombie(Prototype):
        def __init__(self):
            ...
            self.cast = False
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/zombie.gif'
            )
            Prototype.__init__(self)
    ...
    class Ghost(Prototype):
        def __init__(self):
            ...
            self.health = 13
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/ghost.gif'
            )
            Prototype.__init__(self)
    ...
    class Vampire(Prototype):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/vampire.gif'
            )
            Prototype.__init__(self)
    ...
    class Werewolf(Prototype):
        def __init__(self):
            ...
            self.health = 16
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/werewolf.gif'
            )
            Prototype.__init__(self)
    ...
    class Banshee(Prototype):
        def __init__(self):
            ...
            self.health = 12
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/banshee.gif'
            )
            Prototype.__init__(self)
    ...
    class GrimReaper(Prototype):
        def __init__(self):
            ...
            self.health = 22
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/grim_reaper.gif'
            )
            Prototype.__init__(self)
    ...
    class Darklord(Prototype):
        def __init__(self):
            ...
            self.health = 14
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/darklord.gif'
            )
            Prototype.__init__(self)
    ...
    class Lich(Prototype):
        def __init__(self):
            ...
            self.health = 18
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/lich.gif'
            )
            Prototype.__init__(self)
    ...
    class Poison(Magic):
        def __init__(self):
            ...
            self.level = 3
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/poison.gif'
            )
            self.info = _(
    ...
    class SeaJustice(Magic):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/sea_justice.gif'
            )
            Magic.__init__(self)
    ...
    class Paralyze(Magic):
        def __init__(self):
            ...
            self.level = 10
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/paralyze.gif'
            )
            self.info = _(
    ...
    class AcidStorm(Magic):
        def __init__(self):
            ...
            self.level = 9
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/acid_storm.gif'
            )
            self.info = _(
    ...
    class IceBolt(Magic):
        def __init__(self):
            ...
            self.level = 7
            self.image = pygame.image.load(
                current_folder + '/misc/cards/water/ice_bolt.gif'
            )
            self.info = _(
    ...
    class Armageddon(Magic):
        def __init__(self):
            ...
            self.level = 11
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/armageddon.gif'
            )
            self.info = _(
    ...
    class Fireball(Magic):
        def __init__(self):
            ...
            self.level = 8
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/fireball.gif'
            )
            self.info = _(
    ...
    class FireSpikes(Magic):
        def __init__(self):
            ...
            self.level = 3
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/fire_spikes.gif'
            )
            self.info = _(
    ...
    class FlamingArrow(Magic):
        def __init__(self):
            ...
            self.level = 4
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/flaming_arrow.gif'
            )
            self.info = _(
    ...
    class RitualFlame(Magic):
        def __init__(self):
            ...
            self.level = 5
            self.image = pygame.image.load(
                current_folder + '/misc/cards/fire/ritual_flame.gif'
            )
            self.info = _(
    ...
    class BlackWind(Magic):
        def __init__(self):
            ...
            self.level = 8
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/black_wind.gif'
            )
            self.info = _(
    ...
    class ChainLightning(Magic):
        def __init__(self):
            ...
            self.level = 9
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/chain_lightning.gif'
            )
            self.info = _(
    ...
    class Plague(Magic):
        def __init__(self):
            ...
            self.level = 12
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/plague.gif'
            )
            self.info = _(
    ...
    class Spellbreaker(Magic):
        def __init__(self):
            ...
            self.level = 7
            self.image = pygame.image.load(
                current_folder + '/misc/cards/air/spellbreaker.gif'
            )
            self.info = _(
    ...
    class AbsoluteDefence(Magic):
        def __init__(self):
            ...
            self.level = 7
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/absolute_defence.gif'
            )
            self.info = _(
    ...
    class Earthquake(Magic):
        def __init__(self):
            ...
            self.level = 10
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/earthquake.gif'
            )
            self.info = _(
    ...
    class Quicksands(Magic):
        def __init__(self):
            ...
            self.level = 6
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/quicksands.gif'
            )
            self.info = _(
    ...
    class Restructure(Magic):
        def __init__(self):
            ...
            self.level = 6
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/restructure.gif'
            )
            self.info = _(
    ...
    class Revival(Magic):
        def __init__(self):
            ...
            self.level = 5
            self.image = pygame.image.load(
                current_folder + '/misc/cards/earth/revival.gif'
            )
            self.info = _(
    ...
    class Bless(Magic):  # TODO: restore of health
        def __init__(self):
            ...
            self.level = 5
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/bless.gif'
            )
            self.info = _(
    ...
    class GodsWrath(Magic):
        def __init__(self):
            ...
            self.level = 10
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/gods_wrath.gif'
            )
            self.info = _(
    ...
    class LifeSacrifice(Magic):
        def __init__(self):
            ...
            self.level = 8
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/life_sacrifice.gif'
            )
            self.info = _(
    ...
    class Purify(Magic):
        def __init__(self):
            ...
            self.level = 7
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/purify.gif'
            )
            self.info = _(
    ...
    class Rejuvenation(Magic):
        def __init__(self):
            ...
            self.level = 6
            self.image = pygame.image.load(
                current_folder + '/misc/cards/life/rejuvenation.gif'
            )
            self.info = _(
    ...
    class ChaosVortex(Magic):
        def __init__(self):
            ...
            self.level = 13
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/chaos_vortex.gif'
            )
            self.info = _(
    ...
    class CoverOfDarkness(Magic):
        def __init__(self):
            ...
            self.level = 11
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/cover_of_darkness.gif'
            )
            self.info = _(
    ...
    class Curse(Magic):
        def __init__(self):
            ...
            self.level = 4
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/curse.gif'
            )
            self.info = _(
    ...
    class StealLife(Magic):
        def __init__(self):
            ...
            self.level = 6
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/steal_life.gif'
            )
            self.info = _(
    ...
    class TotalWeakness(Magic):
        ...
        def __init__(self):
            ...
            self.level = 8
            self.image = pygame.image.load(
                current_folder + '/misc/cards/death/total_weakness.gif'
            )
            self.info = _(
    ...
    links_to_cards = {
        ...
        "Fireball": Fireball,
        "FireSpikes": FireSpikes,
        "FlamingArrow": FlamingArrow,
        "RitualFlame": RitualFlame,
        "Phoenix": Phoenix,
        "Zeus": Zeus,
        "Fairy": Fairy,
        "Nymph": Nymph,
        ...
        "AbsoluteDefence": AbsoluteDefence,
        ...
        "Unicorn": Unicorn,
        "Apostate": Apostate,
        "MagicHealer": MagicHealer,
        "Chimera": Chimera,
        "Bless": Bless,
        "GodsWrath": GodsWrath,
        "LifeSacrifice": LifeSacrifice,
        "Purify": Purify,
