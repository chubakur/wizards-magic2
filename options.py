...
def launcher():
    ...
    try:
        ...
        wzglobals.bg_sound = pygame.mixer.Sound(
            ...
            '/misc/sounds/11_the_march_of_the_goblins__tobias_steinmann.ogg'
        )
...
def read_configuration():
    ...
    try:
        ...
        if wzglobals.animation not in "YN":
    ...
    try:
        ...
        try:
            ...
            if wzglobals.language not in ['ru', 'en', 'de']:
...
def options_main():
    ...
    menu.MenuButton(-1, "SAVE", "options.save()",
                    loc=(70, menupos.height - 50))
    menu.MenuButton(-1, "CANCEL", "options.cancel()",
                    loc=(160, menupos.height - 50))
