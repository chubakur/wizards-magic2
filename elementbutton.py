...
class ElementShower(pygame.sprite.Sprite):
    ...
    def draw(self):
        ...
        if not wzglobals.cli:
            text = wzglobals.font2.render(
                str(wzglobals.player.enemy.mana[self.element]),
                True,
                self.color
            )
        else:
            if not wzglobals.player_id:
                return
            # exec(
            #   "text = self.font.render(str(wzglobals.player" +
            #   str(wzglobals.player_id) +
            #   ".enemy" +
            #   "." +
            #   self.element +
            #   "_mana),True," +
            ...
            if wzglobals.player_id == 1:
                text = wzglobals.font2.render(
                    str(wzglobals.player2.mana[self.element]), True, self.color
                )
            else:
                text = wzglobals.font2.render(
                    str(wzglobals.player1.mana[self.element]), True, self.color
                )
...
class ElementButton(pygame.sprite.Sprite):
    ...
    def draw(self):
        ...
        if not wzglobals.cli:
            ...
            # )
            text = wzglobals.font2.render(
                str(wzglobals.player.mana[self.element]), True, self.color
            )
        else:
            if not wzglobals.player_id:
                return
...
class WaterElementButton(ElementButton):
    ...
    def __init__(self, rect):
        ...
        self.image_normal = pygame.image.load(
            current_folder + '/misc/water_icon.gif'
        ).convert_alpha()
        self.image_pressed = pygame.image.load(
            current_folder + '/misc/water_icon_selected.gif'
        ).convert_alpha()
        self.image = self.image_pressed
        self.color = (255, 255, 255)
...
class FireElementButton(ElementButton):
    ...
    def __init__(self, rect):
        self.element = 'fire'
        self.image_normal = pygame.image.load(
            current_folder + '/misc/fire_icon.gif'
        ).convert_alpha()
        self.image_pressed = pygame.image.load(
            current_folder + '/misc/fire_icon_selected.gif'
        ).convert_alpha()
        self.image = self.image_normal
        self.color = (255, 255, 255)
        self.rect = self.image.get_rect().move((rect[0], rect[1]))
...
class AirElementButton(ElementButton):
    ...
    def __init__(self, rect):
        self.element = 'air'
        self.image_normal = pygame.image.load(
            current_folder + '/misc/air_icon.gif'
        ).convert_alpha()
        self.image_pressed = pygame.image.load(
            current_folder + '/misc/air_icon_selected.gif'
        ).convert_alpha()
        self.image = self.image_normal
        self.color = (255, 255, 255)
        self.rect = self.image.get_rect().move((rect[0], rect[1]))
...
class EarthElementButton(ElementButton):
    ...
    def __init__(self, rect):
        self.element = 'earth'
        self.image_normal = pygame.image.load(
            current_folder + '/misc/earth_icon.gif'
        ).convert_alpha()
        self.image_pressed = pygame.image.load(
            current_folder + '/misc/earth_icon_selected.gif'
        ).convert_alpha()
        self.image = self.image_normal
        self.color = (255, 255, 255)
        self.surface_backup = self.image.copy()
...
class LifeElementButton(ElementButton):
    ...
    def __init__(self, rect):
        self.element = 'life'
        self.image_normal = pygame.image.load(
            current_folder + '/misc/life_icon.gif'
        ).convert_alpha()
        self.image_pressed = pygame.image.load(
            current_folder + '/misc/life_icon_selected.gif'
        ).convert_alpha()
        self.image = self.image_normal
        self.color = (255, 255, 255)
        self.rect = self.image.get_rect().move((rect[0], rect[1]))
...
class DeathElementButton(ElementButton):
    ...
    def __init__(self, rect):
        self.element = 'death'
        self.image_normal = pygame.image.load(
            current_folder + '/misc/death_icon.gif'
        ).convert_alpha()
        self.image_pressed = pygame.image.load(
            current_folder + '/misc/death_icon_selected.gif'
        ).convert_alpha()
        self.image = self.image_normal
        self.color = (255, 255, 255)
        self.rect = self.image.get_rect().move((rect[0], rect[1]))
